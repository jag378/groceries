# -*- coding: utf-8 -*-
"""
Created on Wed Jan 23 17:07:55 2019
...
print("There are " + str(products_count) + " total products")
...
for p in products:    
    price_round = p["price"]
    price_round = 'the price is ${0:.2f}'.format(6.5)
    print("The name is " + p["name"] + "and the price is " + str(price_round))
...
print("There are " + str(department_count) + " different departments")
